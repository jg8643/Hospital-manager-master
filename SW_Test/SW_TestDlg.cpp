...
CSWTestDlg::CSWTestDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SW_TEST_DIALOG, pParent)
{
...
void CSWTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CSWTestDlg::OnQueryDragIcon()
{
